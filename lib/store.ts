...
const SEED_CHECKLISTS: Checklist[] = [
  {
    ...
    itens: [
      { id: "i1", texto: "Realizou abordagem inicial padrão", peso: 5 },
      { id: "i2", texto: "Confirmou dados cadastrais do cliente", peso: 10, critico: true },
      { id: "i3", texto: "Sondou a necessidade do cliente", peso: 8 },
      { id: "i4", texto: "Ofertou o produto corretamente", peso: 10 },
      { id: "i5", texto: "Informou valores e condições com clareza", peso: 12 },
      { id: "i6", texto: "Contornou objeções de forma adequada", peso: 8 },
      { id: "i7", texto: "Realizou script de segurança/LGPD", peso: 15, critico: true },
      { id: "i8", texto: "Manteve cordialidade durante o atendimento", peso: 7 },
      { id: "i9", texto: "Confirmou aceite e fechamento da venda", peso: 10 },
      { id: "i10", texto: "Realizou encerramento padrão", peso: 5 },
    ],
  },
  {
    id: "chk-carteira-y",
    ...
    atualizadoEm: new Date().toISOString(),
    itens: [
      { id: "y1", texto: "Identificou motivo do cancelamento", peso: 12, critico: true },
      { id: "y2", texto: "Apresentou oferta de retenção", peso: 15 },
      { id: "y3", texto: "Demonstrou empatia com o cliente", peso: 8 },
      { id: "y4", texto: "Registrou tabulação correta no sistema", peso: 10 },
      { id: "y5", texto: "Seguiu script de segurança", peso: 15, critico: true },
      { id: "y6", texto: "Confirmou decisão final do cliente", peso: 10 },
      { id: "y7", texto: "Encerramento cordial", peso: 5 },
    ],
  },
  {
    id: "chk-carteira-z",
    ...
    atualizadoEm: new Date().toISOString(),
    itens: [
      { id: "z1", texto: "Confirmou identidade do devedor", peso: 15, critico: true },
      { id: "z2", texto: "Informou valor e vencimento da dívida", peso: 12 },
      { id: "z3", texto: "Negociou condições de pagamento", peso: 10 },
      { id: "z4", texto: "Manteve tom respeitoso (sem constrangimento)", peso: 15, critico: true },
      { id: "z5", texto: "Ofereceu canais de pagamento", peso: 8 },
      { id: "z6", texto: "Registrou acordo corretamente", peso: 10 },
      { id: "z7", texto: "Encerramento padrão", peso: 5 },
    ],
  },
]
