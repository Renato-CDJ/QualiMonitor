      ...
      <CardContent className="flex flex-col gap-5 pt-5">
        {blocos.length === 0 ? <p className="py-16 text-center text-sm text-muted-foreground">Sem apontamentos para os filtros selecionados.</p> : <>
          ...
          <div className="flex flex-col gap-3 rounded-xl border bg-muted/10 p-4">
            <div className="flex flex-wrap items-center justify-between gap-2"><div><p className="text-sm font-semibold">Mapa de desempenho por tópico</p><p className="text-xs text-muted-foreground">Ordenado alfabeticamente para facilitar a apresentação e a consulta.</p></div><Badge variant="secondary">{blocos.length} tópicos</Badge></div>
