...
export function LoginScreen() {
  ...
  return (
    <main className="relative flex min-h-svh flex-col items-center justify-start overflow-hidden bg-white px-4 pb-10 pt-[18vh] text-[#242424]">
      ...
      <div className="relative z-10 mb-16 flex w-full select-none justify-center px-4 duration-500 animate-in fade-in slide-in-from-top-4">
        <NeonTitle text="Quali.Monitor" />
      </div>

      <div className="relative z-10 w-full max-w-sm animate-in fade-in zoom-in-95 duration-500">
        <div className="rounded-2xl border border-[#242424]/15 bg-white/90 p-6 shadow-[0_18px_50px_rgba(36,36,36,0.12)] backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="usuario" className="text-sm font-medium text-[#242424]">Nome de usuário</Label>
              <div className="relative">
                <User className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-[#777]" />
                <Input
                  id="usuario"
                  autoFocus
                  autoComplete="off"
                  ...
                  className="border-[#242424]/20 bg-white pl-9 text-[#242424] placeholder:text-[#888] focus-visible:border-[#f26522] focus-visible:ring-[#f26522]/25"
                  aria-invalid={!!erro}
              ...
              <div className="flex animate-in flex-col gap-1.5 fade-in slide-in-from-top-1 duration-300">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="border-[#242424]/20 bg-white px-9 text-[#242424] placeholder:text-[#888] focus-visible:border-[#f26522] focus-visible:ring-[#f26522]/25"
                    aria-invalid={!!erro}
                  />
            ...
            <Button type="submit" disabled={carregando} className="group mt-1 gap-2 bg-[#f26522] text-white hover:bg-[#d95316]">
          ...
          <Button type="button" variant="outline" onClick={loginVisitante} disabled={carregando} className="group w-full gap-2 border-[#242424]/20 bg-white text-[#242424] hover:border-[#f26522] hover:bg-[#fff4ee] hover:text-[#242424]">
