  ...
  return (
    <main className="mx-auto flex max-w-[1400px] flex-col gap-6 px-4 py-6 md:px-6 md:py-8">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card><CardContent className="flex items-center gap-3 p-5"><div className="flex size-10 items-center justify-center rounded-xl bg-chart-5/10 text-chart-5"><Check className="size-5" /></div><div><p className="text-2xl font-semibold">{vinculos.length}</p><p className="text-xs text-muted-foreground">Vínculos configurados</p></div></CardContent></Card>
        <Card><CardContent className="flex items-center gap-3 p-5"><div className="flex size-10 items-center justify-center rounded-xl bg-primary/10 text-primary"><ArrowRight className="size-5" /></div><div><p className="text-2xl font-semibold">{carteirasAtivas.length}</p><p className="text-xs text-muted-foreground">Carteiras disponíveis</p></div></CardContent></Card>
      </div>
